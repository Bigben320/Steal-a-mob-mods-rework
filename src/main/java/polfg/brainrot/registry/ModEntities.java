...
public final class ModEntities {
    ...
    // ЕСЛИ CI СКАЖЕТ, что build(ResourceKey) не подходит для 1.21.4 — заменить
    // последнюю строку на:  .build("brainrot")
    // (в этой версии сигнатуру меняли, точную проверит первый билд)
}
